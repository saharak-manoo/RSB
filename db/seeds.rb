...
if Product.count.zero?
  products = [
    ...
    {
      name: 'โต๊ะทำงาน ขนาด 100 ซม. รุ่น EMMA',
      price: 2_190.0
    },
    {
      name: 'โต๊ะทำงาน ขนาด 120 ซม. รุ่น ELLA สีไม้อ่อน',
      price: 2_090.0
    },
    {
      name: 'ตู้และอุปกรณ์สำนักงาน ขนาด 120 ซม. รุ่น Able',
      price: 3_200.0
    },
    {
      name: 'ชุดโต๊ะอาหาร รุ่น Ruber',
      price: 7_500.0
    },
    {
      name: 'ชุดโต๊ะอาหาร รุ่น Famira สีน้ำตาล',
      price: 24_900.0
    },
    {
      name: 'ชุดโต๊ะอาหาร รุ่น Famira สีน้ำตาล',
    ...
    {
      name: 'ชั้นวางทีวี ขนาด 240 ซม. รุ่น Maximus',
      price: 7_000.0
    },
    {
      name: 'ชั้นวางทีวี ขนาด 160 ซม. รุ่น Tavern สีลายไม้ธรรมชาติ',
      price: 4_999.0
    }
  ]
